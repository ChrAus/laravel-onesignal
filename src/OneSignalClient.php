...
class OneSignalClient
{
    ...
    public function sendNotificationToAll($message, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null, $icon=null, $image=null) {
        $contents = array(
            "en" => $message
        );
